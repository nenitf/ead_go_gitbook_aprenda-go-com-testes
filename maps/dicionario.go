...
// maps envia a própria definição, não necessitando esperar um ponteiro na
// struct do método, ou seja, sempre que for trabalhado com map o valor
// original vai ser modificado

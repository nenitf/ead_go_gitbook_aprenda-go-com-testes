...
func TestAdiciona(t *testing.T) {
	// Um map deve ser inicializado como vazio ou com make:
	// dicionario := map[string]string{}
	// dicionario := make(map[string]string)
	//
	// Pois se for feito com: var dicionario Dicionario
	// inicializa como nil, criando runtime error caso
	// seja tentado adicionar algum valor
